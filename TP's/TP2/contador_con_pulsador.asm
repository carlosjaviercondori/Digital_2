...
;------------------------------------------------------------------------------
; PROGRAMA: Contador con pulsador
; DESCRIPCIÓN: Este programa implementa un contador que incrementa su valor
;             cuando se presiona un pulsador conectado a RC0.
; 
; REGISTROS UTILIZADOS:
; - PORTD: Puerto de salida para mostrar el valor del contador en LEDs
; - PORTC.0: Entrada para el pulsador
; - C1, C2: Registros para el retardo
;------------------------------------------------------------------------------
